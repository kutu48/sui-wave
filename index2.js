...
(async () => {
    const pathToFile = './mnemonic.json'; // Jika file berada di direktori yang sama dengan script
    const mnemonics = JSON.parse(fs.readFileSync(pathToFile, 'utf8'));
    const SUI_MNEMONIC = mnemonics[0];
